<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800">Tambah Alternatif</h2>
    </x-slot>

    <div class="py-6 max-w-xl mx-auto px-4">
        <form method="POST" action="{{ route('hrd.alternatif.store') }}" class="bg-white p-6 shadow rounded-lg space-y-5">
            @csrf
